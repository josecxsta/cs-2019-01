...
public class AlgoritmosTest {
    ...
    @Test
    public void CPFTrue() {
        assertTrue(Algoritmos.validaCpf("04080524145"));
    }

    @Test
    public void CPFFalse() {
        assertFalse(Algoritmos.validaCpf("63377387055"));
    }

    @Test
    public void CPFHigherArgument() {
        assertThrows(IllegalArgumentException.class, () -> Algoritmos.validaCpf("63377387055555"));
    }

    @Test
    public void CPFLowerArgument() {
        assertThrows(IllegalArgumentException.class, () -> Algoritmos.validaCpf("63377387"));
    }

    @Test
    public void CPF2True() {
        assertTrue(Algoritmos.validaCpf2("04080524145"));
    }

    @Test
    public void CPF2False() {
        assertFalse(Algoritmos.validaCpf2("12345678912"));
    }

    @Test
    public void CPF2HigherArgument() {
        assertThrows(IllegalArgumentException.class, () -> Algoritmos.validaCpf2("63377387055555"));
    }

    @Test
    public void CPF2LowerArgument() {
        assertThrows(IllegalArgumentException.class, () -> Algoritmos.validaCpf2("63377387"));
    }
