...
package com.github.josecxsta.ufg.cs.aula11.domain;
...
public final class Calendario {
    ...
    public static String[] semana() {
        return new String[] { "segunda-feira", "terça-feira", "quarta-feira", "quinta-feira", "sexta-feira", "sábado",
                "domingo" };
    };
    ...
    /**
     * Obtem a diferença em dias entre duas datas.
     * @param dataInicial data inicial no formato 'dd-MM-yyy'
     * @param dataFinal  data final no formato 'dd-MM-yyy'
     * @return diferença em dias
     * @throws ParseException se houver erro ao parsear data
     */
    public static int diferencaEntreDatas(final String dataInicial,
